...
<script type="text/javascript">
    $(function () {
        ...
        // 2.调用执行分页的函数，显示分页效果
        //这是个坑，坑了半天，乱码解决：需要将自己的js文件保存为utf-8带BOM的
        //防止递归pagination，源码应该注释掉后面的回调函数
        generatePage();
...
<%@include file="modals/modal-role-add.jsp" %>
<%@include file="modals/modal-role-edit.jsp"%>
<%@include file="modals/modal-role-confirm.jsp"%>
<%@include file="modals/modal-role-assign-auth.jsp"%>
</body>
</html>