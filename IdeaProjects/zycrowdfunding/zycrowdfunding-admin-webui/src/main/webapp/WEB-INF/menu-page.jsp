...
<script src="static/crowd/my-menu.js"></script>
<script>
    $(function () {
...
<%@include file="modals/modal-menu-add.jsp" %>
<%@include file="modals/modal-menu-confirm.jsp" %>
<%@include file="modals/modal-menu-edit.jsp" %>
</body>
</html>