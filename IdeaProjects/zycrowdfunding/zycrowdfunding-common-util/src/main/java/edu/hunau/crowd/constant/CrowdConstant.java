package edu.hunau.crowd.constant;
...
public class CrowdConstant {
    ...
    public static final String MESSAGE_HEADER_PIC_UPLOAD_FAILED = "详情图片上传失败！";
    public static final String MESSAGE_DETAIL_PIC_EMPTY = "详情图片不可为空！";
    public static final String MESSAGE_DETAIL_PIC_UPLOAD_FAILED = "头图上传失败！";
    ...
    public static final String ATTR_NAME_DETAIL_DATA = "detailProjectVO";
}
