 ...
 * @see #DelegatingFilterProx(Filter)
 * @see #DelegatingFilterProx(String)
 * @see #DelegatingFilterProx(String, WebApplicationContext)
 * @see javax.servlet.ServletContext#addFilter(String, Filter)
 * @see org.springframework.web.WebApplicationInitializer
 */
public class DelegatingFilterProx extends GenericFilterBean {
     ...
     */
    public DelegatingFilterProx(Filter delegate) {
     ...
     * @see #setEnvironment(org.springframework.core.env.Environment)
     */
    public DelegatingFilterProx(String targetBeanName) {
     ...
     * @see #setEnvironment(org.springframework.core.env.Environment)
     */
    public DelegatingFilterProx(String targetBeanName, WebApplicationContext wac) {
