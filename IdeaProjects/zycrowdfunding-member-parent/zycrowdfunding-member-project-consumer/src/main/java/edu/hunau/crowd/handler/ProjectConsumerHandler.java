...
import edu.hunau.crowd.config.OSSProperties;
import edu.hunau.crowd.constant.CrowdConstant;
import edu.hunau.crowd.entity.vo.*;
...
public class ProjectConsumerHandler {
    ...
    public String getDetailProjectVO(@PathVariable("projectId") Integer projectId, Model model) {
        ...
        if (ResultEntity.SUCCESS.equals(detailProjectVOResultEntity.getResult())){
            ...
            model.addAttribute(CrowdConstant.ATTR_NAME_DETAIL_DATA,detailProjectVO);
        }
    ...
    public String saveConfirm(ModelMap modelMap, HttpSession session, MemberConfirmInfoVO memberConfirmInfoVO) {
        ...
        return "redirect:http://www.zycrowd.com/project/create/success";
    }
    ...
    public String saveProjectBasicInfo(
        ...
        return "redirect:http://www.zycrowd.com/project/return/info/page";
    }
}
